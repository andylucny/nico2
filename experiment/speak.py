...
en_dictionary = {
    ...
    "@calibration" : "Now we will calibrate the eye tracker. For calibration, stand up and look from the top at the red point in the middle and corners of the screen. Then sit down and touch the touchscreen.",
