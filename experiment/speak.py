...
sk_dictionary = {
    ...
    "@calibration" : "Teraz budeme kalibrovať sledovanie pohybu očí. Pri kalibrácii sa postavte a zhora pozerajte vždy na červený bod v strede alebo v rohoch obrazovky a snažte sa, aby sa zmenil na zelený. Po ukončení kalibrácie sa posaďte a svoju pripravenosť začať experiment potvrďte tromi dotykmi obrazovky v rôznych miestach, aby ste sa pritom s činnosťou obrazovky zoznámili.",
    "@no-calibration" : "Prosím, sadnite si a keď budete pripravený začať, potvrďte to tromi dotykmi obrazovky v rôznych miestach, aby ste sa pritom s činnosťou obrazovky zoznámili.",
